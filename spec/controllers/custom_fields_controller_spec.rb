...
RSpec.describe CustomFieldsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested custom_field as @custom_field" do
      custom_field = CustomField.create! valid_attributes
      get :show, params: {id: custom_field.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested custom_field as @custom_field" do
      custom_field = CustomField.create! valid_attributes
      get :edit, params: {id: custom_field.to_param}, session: valid_session
      expect(assigns(:custom_field)).to eq(custom_field)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new CustomField" do
        expect {
          post :create, params: {custom_field: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved custom_field as @custom_field" do
        post :create, params: {custom_field: invalid_attributes}, session: valid_session
        expect(assigns(:custom_field)).to be_a_new(CustomField)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested custom_field" do
        custom_field = CustomField.create! valid_attributes
        put :update, params: {id: custom_field.to_param, custom_field: new_attributes}, session: valid_session
        custom_field.reload
      ...
      it "assigns the requested custom_field as @custom_field" do
        custom_field = CustomField.create! valid_attributes
        put :update, params: {id: custom_field.to_param, custom_field: valid_attributes}, session: valid_session
        expect(assigns(:custom_field)).to eq(custom_field)
      end
    ...
    context "with invalid params" do
      it "assigns the custom_field as @custom_field" do
        custom_field = CustomField.create! valid_attributes
        put :update, params: {id: custom_field.to_param, custom_field: invalid_attributes}, session: valid_session
        expect(assigns(:custom_field)).to eq(custom_field)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested custom_field" do
      custom_field = CustomField.create! valid_attributes
      expect {
        delete :destroy, params: {id: custom_field.to_param}, session: valid_session
      }.to change(CustomField, :count).by(-1)
    end
